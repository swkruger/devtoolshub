...
export function SignInModal({ open, onOpenChange, redirectTo = '/dashboard' }: SignInModalProps) {
  ...
  useEffect(() => {
    ...
    checkAuthStatus()
  }, [open, router, redirectTo, onOpenChange])

  const handleOAuthSignIn = async (provider: 'google' | 'github') => {
    try {
      setIsLoading(provider)
      
      // Use parameters to ensure fresh auth
      const queryParams = {
        ...(provider === 'google' && {
        ...
        <DialogContent className="max-w-md p-0 overflow-hidden">
          ...
          <div className="flex items-center justify-center py-12 px-8">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-600 dark:text-gray-400 font-medium">Checking authentication...</span>
            </div>
          </div>
        </DialogContent>
      </Dialog>
      ...
      <DialogContent className="max-w-md p-0 overflow-hidden">
        <DialogHeader className="px-8 pt-8 pb-6 mb-4">
          ...
          <div className="text-base text-center text-gray-600 dark:text-gray-400 mt-2 leading-relaxed">
            ...
            <br />
            <span className="font-medium text-blue-600 dark:text-blue-400">Free forever, no credit cards required</span>
          </div>
        </DialogHeader>
        
        <div className="px-8 pb-8 space-y-6">
          {/* Benefits Section */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200/50 dark:border-blue-800/50 rounded-xl p-6 space-y-4 shadow-sm">
            <div className="flex items-center gap-3 text-sm text-blue-900 dark:text-blue-100">
              <div className="flex-shrink-0 w-5 h-5 bg-blue-100 dark:bg-blue-900/50 rounded-full flex items-center justify-center">
          ...
          <div className="space-y-3">
            <Button 
              className="w-full h-12 text-base font-medium bg-gray-800 hover:bg-gray-700 text-white border-2 border-gray-600 hover:border-gray-500 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-500 dark:hover:border-gray-400 transition-all duration-200 shadow-sm hover:shadow-md" 
              variant="outline"
          ...
          <div className="text-center text-xs text-gray-500 dark:text-gray-400 leading-relaxed pt-2">
